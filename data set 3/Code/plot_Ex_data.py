...
file='../Data/original/Ivol_Acc_Load_data3_w3_w2_50per_STD_trim .lvm'

title = 'Three frequency Sine wave and Two frequency Sine wave with 50% STD'
...
plt.savefig('../Figure/Three frequency Sine wave and Two frequency Sine wave with 50% STD for Input Vs Force', dpi=400)
plt.tight_layout()
...
lines2, labels2 = ax2.get_legend_handles_labels()
ax2.legend(lines1 + lines2, labels1 + labels2, loc=2)
plt.savefig('../Figure/Three frequency Sine wave and Two frequency Sine wave with 50% STD for Input Vs Acceleration', dpi=400)
plt.tight_layout()
